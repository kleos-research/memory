...
LOCAL_HOST_CLI_CONFORMANCE = {
    "status": "verified_local_bundled_candidate",
    "commit": PLATFORM_HARNESS_COMMIT,
    "platform": "macOS arm64",
    "candidate": "private verified bundled engine candidate",
    "candidate_version": "0.0.0-proposal",
    "candidate_size_bytes": 21122544,
    "candidate_sha256": "988192ac9677d5dd55a3642b2da493a0806bb860b5b3c0f509b37ddadee08825",
    "candidate_model_status": "bundled",
    "candidate_source_binding": "private_verified_snapshot",
    "hosts": [
        {
            "name": "Codex",
            "version": "0.149.0",
            "status": "configuration_verified",
            "host_executable_sha256": "134063e133f0b4244fa3b251acf973d4fe4b4aeeacbdc135211bf480f59f1477",
        ...
        },
        {
            ...
            "version": "2.1.239",
            "status": "connected",
            "host_executable_sha256": "2b4f7aafdaa65bcc2335f56a4b276317837203f2c5587b1f2a17ca78ad14e36f",
        ...
        },
        {
            ...
            "version": "1.18.21",
            "status": "connected",
            "host_executable_sha256": "8c783005340f8dfc5e7d168478dd0dd2bd1faead531cb34270de2a9689d9f135",
            "scope": "local host wiring and MCP discovery",
        },
    ],
...
STAGING_EVIDENCE = {
    ...
    "milestones": [
        ...
        },
        {
            ...
            "verification": f"final package evidence SHA-256 {FINAL_PACKAGE_EVIDENCE_SHA256}; host-wiring harness commit {PLATFORM_HARNESS_COMMIT}; bundled private candidate SHA-256 988192ac9677d5dd55a3642b2da493a0806bb860b5b3c0f509b37ddadee08825",
        },
        {
            "id": "DX-10A",
...
<p>Local tests cover <code>codex</code>, <code>claude</code>, <code>cursor</code>, and <code>opencode</code> transforms. In addition, platform-harness commit <code>52ad4d2…</code> exercised pinned Codex <code>0.149.0</code>, Claude Code <code>2.1.239</code>, and OpenCode <code>1.18.21</code> CLI wiring on macOS arm64 against a private verified bundled engine candidate; it verified local connection and stdio discovery of exactly <code>search</code> and <code>remember</code>. This is not released-package, credentialed-model, GUI/IDE, Cursor, or production acceptance. Existing unrelated configuration is preserved; ambiguous, symlinked, tampered, or concurrently edited files are refused.</p>
...
<tr><td><a href="/docs/integrations/claude-code/">Claude Code</a></td><td>Pinned <code>2.1.239</code> local host wiring and MCP discovery passed against a private verified bundled engine candidate; managed <code>.mcp.json</code> render, idempotence, and rollback also passed.</td><td>Local wiring verified; released package/provider held</td></tr>
...
<tr><td><a href="/docs/integrations/opencode/">OpenCode</a></td><td>Pinned <code>1.18.21</code> local host wiring and MCP discovery passed against a private verified bundled engine candidate; stable v1 is default and beta v2 is explicit.</td><td>Local wiring verified; released package/provider held</td></tr>
...
<tr><td>Claude Code / OpenCode</td><td>Pinned local CLI wiring and MCP discovery on macOS arm64 against a private verified bundled engine candidate; config render, dry run, idempotence, and exact rollback.</td><td>Released package, credentialed model, GUI/IDE, and production support acceptance.</td></tr>
...
<tr><td>DX-10B</td><td><code>{FINAL_EVIDENCE_COMMIT}</code>, package evidence <code>{FINAL_PACKAGE_EVIDENCE_SHA256}</code>, host harness <code>{PLATFORM_HARNESS_COMMIT}</code></td><td>Fresh npm/Python facade <code>init</code>, <code>doctor</code>, Codex dry-run configuration, MCP discovery, and pinned local Codex/Claude Code/OpenCode CLI wiring passed on macOS arm64 against a private verified bundled engine candidate. No credentialed model, GUI/IDE, Cursor, released-package, or production acceptance claim.</td></tr>
</tbody></table>
...
<h2>Evidence boundary</h2><p>Renderer, dry-run, idempotence, rollback, and pinned Claude Code <code>2.1.239</code> host wiring passed locally on macOS arm64 against a private verified bundled engine candidate. This verifies local connection and MCP discovery only; credentialed model turns, a released package, and production support acceptance remain held.</p>
""",
    ),
    Page(
...
<h2>Evidence boundary</h2><p>Both renderers and safe mutation paths plus pinned OpenCode <code>1.18.21</code> host wiring passed locally on macOS arm64 against a private verified bundled engine candidate. This verifies local connection and MCP discovery only; credentialed model turns, a released package, and production support acceptance remain held.</p>
""",
    ),
    Page(
